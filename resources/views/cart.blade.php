                ...
                <tbody>
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/serum1.png" alt="Image" class="img-fluid" />
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">5% Mandelic Acid Mild Exfoliating Serum</h2>
                    </td>
                    <td>Rp 131.000</td>
                    <td>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/skincare1.png" alt="Image" class="img-fluid" />
                    </td>
                    <td class="product-name">
                      <h5 class="h5 text-black">ACNE SHOT AC Overnight Treatment Spot Cream</h5>
                    </td>
                    <td>Rp 93.500</td>
                    <td>
                      <div class="input-group mb-3 d-flex align-items-center quantity-container" style="max-width: 120px">
              ...
              <div class="col-md-7">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black">Rp 224.500</strong>
                  </div>
                </div>
                <div class="row mb-5">
                  <div class="col-md-6">
